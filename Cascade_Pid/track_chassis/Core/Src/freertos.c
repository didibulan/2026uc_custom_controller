...
void MX_FREERTOS_Init(void) {
  ...
  osThreadDef(Chassis_Task, App_ChassisTask, osPriorityHigh, 0, 1024);
  ...
  osThreadDef(Alg_Task, App_AlgTask, osPriorityAboveNormal, 0, 4096);
  Alg_TaskHandle = osThreadCreate(osThread(Alg_Task), NULL);

  /* definition and creation of Referee_Task */
  osThreadDef(Referee_Task, App_RefereeTask, osPriorityAboveNormal, 0, 2048);
